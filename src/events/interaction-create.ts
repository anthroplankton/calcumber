...
>(lisenter: T, interaction: TInteraction) {
    ...
    logger.event('Interaction Create', chalk.bgBlue(commandInteractionCreate.name), interactionPath)
    if (interactive == undefined) {
        throw new Error(`The ${commandInteractionCreate.name} interaction "${interactionPath}" does not bind.`)
    }
